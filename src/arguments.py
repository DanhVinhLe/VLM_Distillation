...
class TrainingArguments(TrainingArguments):
    ...
    sic_num_regions: int = field(default=0, metadata={"help": "Fixed number of SIC semantic regions/intervention forwards per image; <=0 falls back to sic_max_clusters, then scva_n_clusters."})
    sic_max_clusters: int = field(default=0, metadata={"help": "Deprecated compatibility alias for SIC region count when sic_num_regions <= 0."})
