#!/usr/bin/env bash
# SCVA-only — DeepSpeed ZeRO-2 multi-GPU.
# Launch:   NPROC_PER_NODE=2 bash script_train/scva/train_..._scva_ds2.sh
set -euo pipefail
...
RUN_NAME="${RUN_NAME:-qwen25_teacher_7b_qwen2_student_2b_scva_ds2}"
